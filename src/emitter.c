...
spawn_colorful_particles(emitter_t *em, int32_t x, int32_t y, uint32_t n, uint32_t flags) {
  ...
  for (int i = 0; i < n; i++) {
    ...
    switch(animationColor) {
      case 0:
        particleAnimation = add_animation("res/img/particles/red/p", 2, random_float(0.166f, 0.70f));
        break;
      case 1:
        particleAnimation = add_animation("res/img/particles/blue/p", 2, random_float(0.166f, 0.70f));
        break;
      case 2:
        particleAnimation = add_animation("res/img/particles/green/p", 2, random_float(0.166f, 0.70f));
        break;
    }
